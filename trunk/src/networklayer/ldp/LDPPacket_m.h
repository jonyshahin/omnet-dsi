...
class LDPLabelMapping : public LDPPacket
{
  ...
  public:
    ...
    virtual void setLabel(int label_var);
};
...
class LDPIni : public LDPPacket
{
  ...
  public:
    ...
    virtual void setKeepAliveTime(double keepAliveTime_var);
    virtual bool getAbit() const;
    virtual void setAbit(bool abit_var);
    virtual bool getDbit() const;
    virtual void setDbit(bool dbit_var);
    virtual int getPvLim() const;
    virtual void setPvLim(int pvLim_var);
    virtual const char * getReceiverLDPIdentifier() const;
    virtual void setReceiverLDPIdentifier(const char * receiverLDPIdentifier_var);
};
