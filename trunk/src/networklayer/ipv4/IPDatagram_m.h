...
class IPDatagram : public cPacket
{
  protected:
    ...
    uint32 output_port_to_core_switch_var;
    float load_var;
  ...
  public:
    ...
    virtual uint32 getOutput_port_to_core_switch() const;
    virtual void setOutput_port_to_core_switch(uint32 output_port_to_core_switch_var);
