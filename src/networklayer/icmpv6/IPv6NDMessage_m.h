...
class IPv6NeighbourAdvertisement : public IPv6NDMessage
{
  ...
  public:
    ...
    virtual void setRouterFlag(bool routerFlag_var);
    virtual bool getSolicitedFlag() const;
    virtual void setSolicitedFlag(bool solicitedFlag_var);
    virtual bool getOverrideFlag() const;
    virtual void setOverrideFlag(bool overrideFlag_var);
    virtual IPv6Address& getTargetAddress();
    ...
    virtual void setTargetLinkLayerAddress(const MACAddress& targetLinkLayerAddress_var);
};
...
class IPv6Redirect : public IPv6NDMessage
{
  ...
  public:
    ...
    virtual void setDestinationAddress(const IPv6Address& destinationAddress_var);
    virtual MACAddress& getTargetLinkLayerAddress();
