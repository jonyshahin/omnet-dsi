//
// Generated file, do not edit! Created by opp_msgc 4.0 from networklayer/icmpv6/ICMPv6Message.msg.
//
...
class ICMPv6EchoRequestMsg : public ICMPv6Message
{
  ...
  public:
    ...
    virtual void setIdentifier(int identifier_var);
    virtual int getSeqNumber() const;
    virtual void setSeqNumber(int seqNumber_var);
};
