...
class INET_API AbstractQueue : public cSimpleModule
{
  ...
  protected:
    ...
    /*
     * A separate queue to maintain the probe packets which are used to find the multiple paths
     * between edge switches in the network
     */
    cPacketQueue pqueue;
     ...
     *
     */
    virtual void doProbeEndService();
};
